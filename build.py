...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','nl.ilouis.omniture.js')
	...
	f = os.path.join(cwd,'Classes','NlIlouisOmnitureModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','nl.ilouis.omniture.js']
